        ...
        <CustomScrollbars className="gx-layout-sider-scrollbar">
          <Menu
            ...
            {/* <MenuItemGroup key="components" className="gx-menu-group" title={<IntlMessages id="sidebar.components"/>}>
              ...
              <SubMenu key="navigation" className={getNavStyleSubMenuClass(navStyle)} title={
                <span>
              ...
              <SubMenu key="dataEntry" className={getNavStyleSubMenuClass(navStyle)} title={
                <span>
              ...
              <SubMenu key="dataDisplay" className={getNavStyleSubMenuClass(navStyle)} title={
                <span>
              ...
              <SubMenu key="feedBack" className={getNavStyleSubMenuClass(navStyle)} title={
                <span>
              ...
              <SubMenu key="others" className={getNavStyleSubMenuClass(navStyle)} title={
                <span>
              ...
              <SubMenu key="table" className={getNavStyleSubMenuClass(navStyle)}
                       title={
                         <span>
            ...
            {/* <MenuItemGroup key="extraComponents" className="gx-menu-group"
              ...
              <SubMenu key="time-line" className={getNavStyleSubMenuClass(navStyle)}
            ...
            {/* <MenuItemGroup key="extensions" className="gx-menu-group" title={<IntlMessages id="sidebar.extensions"/>}>
              ...
              <SubMenu key="map" className={getNavStyleSubMenuClass(navStyle)}
                ...
                <SubMenu key="google" className={getNavStyleSubMenuClass(navStyle)}
                         title={
                           <span>
                ...
                <SubMenu key="ammap" className={getNavStyleSubMenuClass(navStyle)}
                         title={
              ...
              <SubMenu key="chart" className={getNavStyleSubMenuClass(navStyle)}
                       title={<span> <i className="icon icon-chart"/>
                        <span><IntlMessages id="sidebar.chart"/></span></span>}>

                <SubMenu key="rechart" className={getNavStyleSubMenuClass(navStyle)} title={
                ...
                <SubMenu key="amchart" className={getNavStyleSubMenuClass(navStyle)} title={
                  <span><i className="icon icon-amchart"/>
              ...
              <SubMenu key="calendar" className={getNavStyleSubMenuClass(navStyle)}
            ...
            {/* <MenuItemGroup key="custom-views" className="gx-menu-group"
              ...
              <SubMenu key="list-type" className={getNavStyleSubMenuClass(navStyle)}
              ...
              <SubMenu key="eCommerce" className={getNavStyleSubMenuClass(navStyle)}
              ...
              <SubMenu key="errorPages" className={getNavStyleSubMenuClass(navStyle)}
              ...
              <SubMenu key="extra-elements" className={getNavStyleSubMenuClass(navStyle)}
